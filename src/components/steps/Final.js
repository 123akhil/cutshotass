    ...
    <div className="container md:mt-4">
      <div className="flex flex-col items-center">
        ...
        <a className="mt-4 w-full" href="/user/dashboard">
          <button
            className="cursor-pointer rounded-lg bg-violet-600 py-4 text-white text-xs transition duration-200 ease-in-out hover:bg-violet-700 hover:text-white w-[92%] ml-4"
            onClick={(e) => {
              e.preventDefault();
